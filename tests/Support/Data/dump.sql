...
('wp_ahoy_visits','id','bigint'),
('wp_ahoy_visits','visit_token','varchar(255)'),
('wp_ahoy_visits','visitor_token','varchar(255)'),
('wp_ahoy_visits','user_id','bigint'),
('wp_ahoy_visits','ip','varchar(255)'),
('wp_ahoy_visits','user_agent','text'),
('wp_ahoy_visits','referrer','text'),
('wp_ahoy_visits','referring_domain','varchar(255)'),
('wp_ahoy_visits','landing_page','text'),
('wp_ahoy_visits','browser','varchar(255)'),
('wp_ahoy_visits','os','varchar(255)'),
('wp_ahoy_visits','device_type','varchar(255)'),
('wp_ahoy_visits','country','varchar(255)'),
('wp_ahoy_visits','region','varchar(255)'),
('wp_ahoy_visits','city','varchar(255)'),
('wp_ahoy_visits','latitude','decimal(11,'),
('wp_ahoy_visits','longitude','decimal(11,'),
('wp_ahoy_visits','utm_source','varchar(255)'),
('wp_ahoy_visits','utm_medium','varchar(255)'),
('wp_ahoy_visits','utm_term','varchar(255)'),
('wp_ahoy_visits','utm_content','varchar(255)'),
('wp_ahoy_visits','utm_campaign','varchar(255)'),
('wp_ahoy_visits','app_version','varchar(255)'),
('wp_ahoy_visits','os_version','varchar(255)'),
('wp_ahoy_visits','platform','varchar(255)'),
('wp_ahoy_visits','started_at','datetime'),
('wp_ahoy_events','id','bigint'),
('wp_ahoy_events','visit_id','bigint'),
('wp_ahoy_events','user_id','bigint'),
('wp_ahoy_events','name','varchar(255)'),
('wp_ahoy_events','properties','text'),
('wp_ahoy_events','time','datetime');
...
('1','admin','$P$BBMngf36Rdb/5K3DEDdrO2JZBzDqQP0','admin','admin@exmaple.com','http://localhost:6607','2024-03-30 00:13:11','','0','admin');
...
('1','siteurl','http://localhost:6607','yes'),
('2','home','http://localhost:6607','yes'),
('3','blogname','Ahoy Test','yes'),
...
('33','active_plugins','a:1:{i:0;s:16:"wp-ahoy/ahoy.php";}','yes'),
...
('79','uninstall_plugins','a:1:{s:16:"wp-ahoy/ahoy.php";s:14:"ahoy_uninstall";}','no'),
...
('91','admin_email_lifespan','1727309591','yes'),
...
('106','cron','a:3:{i:1711757592;a:4:{s:34:"wp_privacy_delete_old_export_files";a:1:{s:32:"40cd750bba9870f18aada2478b24840a";a:3:{s:8:"schedule";s:6:"hourly";s:4:"args";a:0:{}s:8:"interval";i:3600;}}s:16:"wp_version_check";a:1:{s:32:"40cd750bba9870f18aada2478b24840a";a:3:{s:8:"schedule";s:10:"twicedaily";s:4:"args";a:0:{}s:8:"interval";i:43200;}}s:17:"wp_update_plugins";a:1:{s:32:"40cd750bba9870f18aada2478b24840a";a:3:{s:8:"schedule";s:10:"twicedaily";s:4:"args";a:0:{}s:8:"interval";i:43200;}}s:16:"wp_update_themes";a:1:{s:32:"40cd750bba9870f18aada2478b24840a";a:3:{s:8:"schedule";s:10:"twicedaily";s:4:"args";a:0:{}s:8:"interval";i:43200;}}}i:1711843992;a:1:{s:30:"wp_site_health_scheduled_check";a:1:{s:32:"40cd750bba9870f18aada2478b24840a";a:3:{s:8:"schedule";s:6:"weekly";s:4:"args";a:0:{}s:8:"interval";i:604800;}}}s:7:"version";i:2;}','yes'),
...
('1','1','2024-03-30 00:13:11','2024-03-30 00:13:11','<!-- wp:paragraph -->' || char(10) || '<p>Welcome to WordPress. This is your first post. Edit or delete it, then start writing!</p>' || char(10) || '<!-- /wp:paragraph -->','Hello world!','','publish','open','open','','hello-world','','','2024-03-30 00:13:11','2024-03-30 00:13:11','','0','http://localhost:6607/?p=1','0','post','','1'),
('2','1','2024-03-30 00:13:11','2024-03-30 00:13:11','<!-- wp:paragraph -->' || char(10) || '<p>This is an example page. It''s different from a blog post because it will stay in one place and will show up in your site navigation (in most themes). Most people start with an About page that introduces them to potential site visitors. It might say something like this:</p>' || char(10) || '<!-- /wp:paragraph -->' || char(10) || '' || char(10) || '<!-- wp:quote -->' || char(10) || '<blockquote class="wp-block-quote"><p>Hi there! I''m a bike messenger by day, aspiring actor by night, and this is my website. I live in Los Angeles, have a great dog named Jack, and I like pi&#241;a coladas. (And gettin'' caught in the rain.)</p></blockquote>' || char(10) || '<!-- /wp:quote -->' || char(10) || '' || char(10) || '<!-- wp:paragraph -->' || char(10) || '<p>...or something like this:</p>' || char(10) || '<!-- /wp:paragraph -->' || char(10) || '' || char(10) || '<!-- wp:quote -->' || char(10) || '<blockquote class="wp-block-quote"><p>The XYZ Doohickey Company was founded in 1971, and has been providing quality doohickeys to the public ever since. Located in Gotham City, XYZ employs over 2,000 people and does all kinds of awesome things for the Gotham community.</p></blockquote>' || char(10) || '<!-- /wp:quote -->' || char(10) || '' || char(10) || '<!-- wp:paragraph -->' || char(10) || '<p>As a new WordPress user, you should go to <a href="http://localhost:6607/wp-admin/">your dashboard</a> to delete this page and create new pages for your content. Have fun!</p>' || char(10) || '<!-- /wp:paragraph -->','Sample Page','','publish','closed','open','','sample-page','','','2024-03-30 00:13:11','2024-03-30 00:13:11','','0','http://localhost:6607/?page_id=2','0','page','','0'),
('3','1','2024-03-30 00:13:11','2024-03-30 00:13:11','<!-- wp:heading --><h2>Who we are</h2><!-- /wp:heading --><!-- wp:paragraph --><p><strong class="privacy-policy-tutorial">Suggested text: </strong>Our website address is: http://localhost:6607.</p><!-- /wp:paragraph --><!-- wp:heading --><h2>Comments</h2><!-- /wp:heading --><!-- wp:paragraph --><p><strong class="privacy-policy-tutorial">Suggested text: </strong>When visitors leave comments on the site we collect the data shown in the comments form, and also the visitor&#8217;s IP address and browser user agent string to help spam detection.</p><!-- /wp:paragraph --><!-- wp:paragraph --><p>An anonymized string created from your email address (also called a hash) may be provided to the Gravatar service to see if you are using it. The Gravatar service privacy policy is available here: https://automattic.com/privacy/. After approval of your comment, your profile picture is visible to the public in the context of your comment.</p><!-- /wp:paragraph --><!-- wp:heading --><h2>Media</h2><!-- /wp:heading --><!-- wp:paragraph --><p><strong class="privacy-policy-tutorial">Suggested text: </strong>If you upload images to the website, you should avoid uploading images with embedded location data (EXIF GPS) included. Visitors to the website can download and extract any location data from images on the website.</p><!-- /wp:paragraph --><!-- wp:heading --><h2>Cookies</h2><!-- /wp:heading --><!-- wp:paragraph --><p><strong class="privacy-policy-tutorial">Suggested text: </strong>If you leave a comment on our site you may opt-in to saving your name, email address and website in cookies. These are for your convenience so that you do not have to fill in your details again when you leave another comment. These cookies will last for one year.</p><!-- /wp:paragraph --><!-- wp:paragraph --><p>If you visit our login page, we will set a temporary cookie to determine if your browser accepts cookies. This cookie contains no personal data and is discarded when you close your browser.</p><!-- /wp:paragraph --><!-- wp:paragraph --><p>When you log in, we will also set up several cookies to save your login information and your screen display choices. Login cookies last for two days, and screen options cookies last for a year. If you select &quot;Remember Me&quot;, your login will persist for two weeks. If you log out of your account, the login cookies will be removed.</p><!-- /wp:paragraph --><!-- wp:paragraph --><p>If you edit or publish an article, an additional cookie will be saved in your browser. This cookie includes no personal data and simply indicates the post ID of the article you just edited. It expires after 1 day.</p><!-- /wp:paragraph --><!-- wp:heading --><h2>Embedded content from other websites</h2><!-- /wp:heading --><!-- wp:paragraph --><p><strong class="privacy-policy-tutorial">Suggested text: </strong>Articles on this site may include embedded content (e.g. videos, images, articles, etc.). Embedded content from other websites behaves in the exact same way as if the visitor has visited the other website.</p><!-- /wp:paragraph --><!-- wp:paragraph --><p>These websites may collect data about you, use cookies, embed additional third-party tracking, and monitor your interaction with that embedded content, including tracking your interaction with the embedded content if you have an account and are logged in to that website.</p><!-- /wp:paragraph --><!-- wp:heading --><h2>Who we share your data with</h2><!-- /wp:heading --><!-- wp:paragraph --><p><strong class="privacy-policy-tutorial">Suggested text: </strong>If you request a password reset, your IP address will be included in the reset email.</p><!-- /wp:paragraph --><!-- wp:heading --><h2>How long we retain your data</h2><!-- /wp:heading --><!-- wp:paragraph --><p><strong class="privacy-policy-tutorial">Suggested text: </strong>If you leave a comment, the comment and its metadata are retained indefinitely. This is so we can recognize and approve any follow-up comments automatically instead of holding them in a moderation queue.</p><!-- /wp:paragraph --><!-- wp:paragraph --><p>For users that register on our website (if any), we also store the personal information they provide in their user profile. All users can see, edit, or delete their personal information at any time (except they cannot change their username). Website administrators can also see and edit that information.</p><!-- /wp:paragraph --><!-- wp:heading --><h2>What rights you have over your data</h2><!-- /wp:heading --><!-- wp:paragraph --><p><strong class="privacy-policy-tutorial">Suggested text: </strong>If you have an account on this site, or have left comments, you can request to receive an exported file of the personal data we hold about you, including any data you have provided to us. You can also request that we erase any personal data we hold about you. This does not include any data we are obliged to keep for administrative, legal, or security purposes.</p><!-- /wp:paragraph --><!-- wp:heading --><h2>Where your data is sent</h2><!-- /wp:heading --><!-- wp:paragraph --><p><strong class="privacy-policy-tutorial">Suggested text: </strong>Visitor comments may be checked through an automated spam detection service.</p><!-- /wp:paragraph -->','Privacy Policy','','draft','closed','open','','privacy-policy','','','2024-03-30 00:13:11','2024-03-30 00:13:11','','0','http://localhost:6607/?page_id=3','0','page','','0');

CREATE TABLE "wp_ahoy_visits" (
"id" integer PRIMARY KEY AUTOINCREMENT NOT NULL,
"visit_token" text COLLATE NOCASE,
"visitor_token" text COLLATE NOCASE,
"user_id" integer,
"ip" text COLLATE NOCASE,
"user_agent" text COLLATE NOCASE,
"referrer" text COLLATE NOCASE,
"referring_domain" text COLLATE NOCASE,
"landing_page" text COLLATE NOCASE,
"browser" text COLLATE NOCASE,
...
"latitude" real,
"longitude" real,
"utm_source" text COLLATE NOCASE,
"utm_medium" text COLLATE NOCASE,
"utm_term" text COLLATE NOCASE,
"utm_content" text COLLATE NOCASE,
"utm_campaign" text COLLATE NOCASE,
"app_version" text COLLATE NOCASE,
"os_version" text COLLATE NOCASE,
"platform" text COLLATE NOCASE,
"started_at" text COLLATE NOCASE);

CREATE TABLE "wp_ahoy_events" (
"id" integer PRIMARY KEY AUTOINCREMENT NOT NULL,
"visit_id" integer,
"user_id" integer,
"name" text COLLATE NOCASE,
"properties" text COLLATE NOCASE,
